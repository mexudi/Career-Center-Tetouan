...
@section('content')
<div class="mt-3">
    <h2 style="font-family: Roboto;font-size: 2rem; font-weight: 900;">Create new Etablishment</h2>
</div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ url('/establishments/store') }}">
            ...
            <div class="mb-3">
                ...
                <input value="{{old('shortName')}}" type="text" class="form-control" name="shortName" id="shortName">
                @error('shortName'){{$message}}@enderror
            </div>
            <div class="mb-3">
                <label for="fullName" class="form-label">Full Name Of Etablishment</label>
                <input value="{{old('fullName')}}" type="text" class="form-control" name="fullName" id="fullName">
