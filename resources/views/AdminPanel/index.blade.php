...
<body>
	...
	<div class="mt-5 text-center">
	    	...
	    	Welcome to Admin Panel Control</h2>
...
<div class="container d-flex justify-content-center" style="margin-top:80px;">
		...
		<a href="{{url('/home')}}" class="btn btn-outline-info mr-3 " >Home Infos</a>
		<a href="{{url('/participation')}}" class="btn btn-outline-info mr-3" >View Participations Lists </a>
		<a href="{{url('/feedback')}}" class="btn btn-outline-info mr-3" >View Feedbacks Lists</a>
		<a href="{{url('/establishments')}}" class="btn btn-outline-info mr-3" >Adding new Establishment</a>
